...
export function Navbar() {
  ...
  return (
    ...
    >
          ...
          <div className="flex-shrink-0">
            <a href="#hero" aria-label={t("brand")} className="cursor-pointer">
              <Image
                ...
                height={80}
                priority
                className={`${isScrolled ? "drop-shadow-[0_0_6px_rgba(0,0,0,0.3)]" : "drop-shadow-[0_2px_6px_rgba(0,0,0,0.5)]"} h-16 w-auto md:h-20 lg:h-24`}
              />
            </a>
          </div>
      ...
      {/* Mobile menu panel */}
      <div
        className={`md:hidden transition-all duration-300 ${mobileOpen ? "max-h-96 opacity-100" : "max-h-0 opacity-0 pointer-events-none"} ${
